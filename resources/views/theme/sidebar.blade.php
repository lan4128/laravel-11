                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="#" data-bs-toggle="collapse" data-bs-target="#collapseMaster" aria-expanded="true" aria-controls="collapseMaster">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                                Master Data
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse show" id="collapseMaster" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/products">Product</a>
                                    <a class="nav-link" href="/kategoris">Kategori</a>
                                    <a class="nav-link" href="/kustomers">Kustomer</a>
                            ...
                            <div class="collapse" id="collapseLaporan" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="#">Form 1</a>
                                </nav>
                            </div>
