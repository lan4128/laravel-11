                    ...
                    <div class="card-body">
                        <form action="{{ route('kustomers.update', $kustomer->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $kustomer->name) }}" placeholder="Masukkan Nama Kustomer">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('telp') is-invalid @enderror" name="telp" value="{{ old('telp', $kustomer->telp) }}" placeholder="Masukkan No Telepon">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $kustomer->email) }}" placeholder="Masukkan Email">
